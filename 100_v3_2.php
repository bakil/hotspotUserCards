...
function generateRandomString($length = 5) {
   ...
   // $characters = 'A0H1B2K3C4M5D6N7E8S9XPRTVW';
       $characters = 'a1b2x9w8v3s4n7m6k5e0d';
...
for($i=1;$i<=1000;$i++)
   ...
   //   $rnc=$k.$rn;
    $rnc=$rn;
    //  $rns=$rnc."s";
      $code= "add name=".$rnc." disabled=no   profile=default limit-uptime=3h  limit-bytes-out=419430400 email=may18@100.com "."\r\n";
      $out_text = $code;
      file_put_contents("$out_page_code", $out_text , FILE_APPEND); 
...
$out_text ='
            <article class="  w3-container w3-bordered w3-round">
              ...
              <span  class="valid-title">400MB او 3 ساعات خلال يومان</span>
              
              <span class="valid"></span>
               <span class="network-en">www.freenet.com</span>
              
              
              <span class=" price w3-white w3-round">100 ريال</span>
             </article>
    ';
    file_put_contents("$out_page_card", $out_text , FILE_APPEND); 
    }
